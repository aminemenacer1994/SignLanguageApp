...
public class info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Information"); // for set actionbar title
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.about:
                ...
                intent = new Intent(info.this, about.class);
                info.this.startActivity(intent);
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        switch (arg1) {
                            ...
                            case 0:
                                ...
                                LocaleHelper.setLocale(info.this, "en");
                                info.this.recreate();
                                break;
                            ...
                            case 1:
                                ...
                                LocaleHelper.setLocale(info.this, "fr");
                                info.this.recreate();
                                break;
                            ...
                            case 2:
                                ...
                                LocaleHelper.setLocale(info.this, "ar");
                                info.this.recreate();
                                break;
